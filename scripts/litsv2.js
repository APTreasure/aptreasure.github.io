...
document.addEventListener("DOMContentLoaded", () => {
    ...
    buttons.forEach((button) => {
        ...
        if (!button.classList.contains('popupButton')) {
            ...
            if (span && buttonWave) {
                const textContent = (_a = span.textContent) === null || _a === void 0 ? void 0 : _a.trim(); // Use textContent of the span element
                switch (textContent) {
                    case "Download":
...
document.querySelectorAll('.gameButton').forEach(button => {
    if (!button.classList.contains('popupButton')) {
        button.addEventListener('mouseover', () => {
            var _a, _b;
            (_b = (_a = button.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.downInfo')) === null || _b === void 0 ? void 0 : _b.classList.add('adjusted-margin');
        });
        button.addEventListener('mouseout', () => {
            var _a, _b;
            (_b = (_a = button.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.downInfo')) === null || _b === void 0 ? void 0 : _b.classList.remove('adjusted-margin');
        });
    }
});
// Cull Buttons
...
function switchImage(event) {
    ...
    const isAnimated = currentImg === null || currentImg === void 0 ? void 0 : currentImg.src.includes('parrot_animated.webp');
    if (!isAnimated) {
        currentImg.src = 'images/parrot_animated.gif';
        currentImg.classList.add('parrothover');
        // Store the interval ID for this image.
        const intervalId = setInterval(() => {
            if (!currentImg.matches(':hover')) {
                currentImg.src = 'images/parrot.png';
                clearInterval(intervalId);
                currentImg.classList.remove('parrothover');
                // Remove the intervalId from the map when done.
                intervalMap.delete(currentImg);
            }
        }, 2160);
        // Store the intervalId in the map with the image as the key.
        intervalMap.set(currentImg, intervalId);
    }
}
parrotImgs.forEach(parrotImg => {
    parrotImg.addEventListener('mouseover', switchImage);
    parrotImg.addEventListener('mouseout', () => {
        const intervalId = intervalMap.get(parrotImg);
        // If intervalId exists, clear the interval and reset the image state.
        if (intervalId) {
            clearInterval(intervalId);
            parrotImg.src = 'images/parrot.png'; // Optionally reset the image here.
            parrotImg.classList.remove('parrothover');
            intervalMap.delete(parrotImg); // Remove from the map.
        }
    });
});
function addItem(containerSelector, gameIcon, gameTitle, buttonText, gameVers = '', downAuthor = '', downHost = '', openInNewTab = false, buttonLink = '', roundCorners = true) {
    ...
    link.addEventListener('mouseover', () => {
        var _a, _b;
        (_b = (_a = link.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.downInfo')) === null || _b === void 0 ? void 0 : _b.classList.add('adjusted-margin');
    });
    link.addEventListener('mouseout', () => {
        var _a, _b;
        (_b = (_a = link.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.downInfo')) === null || _b === void 0 ? void 0 : _b.classList.remove('adjusted-margin');
    });
...
(_a = document.querySelector('.search')) === null || _a === void 0 ? void 0 : _a.addEventListener('input', function () {
    ...
    function filterRows() {
        for (const container of containers) {
            if (container === searchContainer)
                continue; // Skip the search container
            const rows = container.querySelectorAll('.row');
            let anyVisible = false;
            rows.forEach(row => {
                var _a, _b, _c;
                const gameTitleElement = row.querySelector('.gameTitle');
                const originalGameTitle = (_a = gameTitleElement === null || gameTitleElement === void 0 ? void 0 : gameTitleElement.textContent) === null || _a === void 0 ? void 0 : _a.trim();
                const gameTitle = (_b = gameTitleElement === null || gameTitleElement === void 0 ? void 0 : gameTitleElement.textContent) === null || _b === void 0 ? void 0 : _b.trim().toLowerCase();
                const cleanGameTitle = gameTitle === null || gameTitle === void 0 ? void 0 : gameTitle.replace(/[^\w\s]/g, '');
                const imageID = (_c = row.querySelector('.gameIcon')) === null || _c === void 0 ? void 0 : _c.src.replace(/^.+\/([^/]+)\.png$/, '$1');
                const titleWords = gameTitle === null || gameTitle === void 0 ? void 0 : gameTitle.split(' ');
                let combinedLetters = '';
                titleWords === null || titleWords === void 0 ? void 0 : titleWords.forEach(word => {
                ...
                const found = combinedLetters.startsWith(searchValue) || (gameTitle === null || gameTitle === void 0 ? void 0 : gameTitle.includes(searchValue)) || (cleanGameTitle === null || cleanGameTitle === void 0 ? void 0 : cleanGameTitle.includes(searchValue));
                if (searchValue && !found) {
                    ...
                    if (gameTitleElement) {
                        gameTitleElement.innerHTML = highlightMatch(originalGameTitle !== null && originalGameTitle !== void 0 ? originalGameTitle : "", searchValue);
                    }
                    setTimeout(() => {
                        row.style.opacity = '1';
                        updateContainerHeight(container);
    ...
    if (timeoutMap.has(this)) {
        clearTimeout(timeoutMap.get(this)); // Clear any previous timeout
    }
    timeoutMap.set(this, setTimeout(filterRows, 200));
});
